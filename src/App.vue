<template>
  <div id="app">
    <div class="container">
      ...
      <div class="footer">
        <h4>
          Original project made️ by
          <p> </p>
          <a href="http://quentincolus.com">Quentin </a> and <a href="https://www.linkedin.com/in/antoine-renault-a84b6398/">Antoine</a>
          <p> </p>
          <a href="http://todost.quentincolus.com/"> Todost</a>
...
export default {
  ...
  methods: {
    assignInitialGretting(){
      ...
      this.initialGretting = grettings[Math.floor(Math.random() * grettings.length)];
    },
    getCurrentDay(){
      const date = new Date();
